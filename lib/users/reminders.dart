...
//     .where("PostedAt",
//         isEqualTo: Timestamp.fromDate(today)) // Filter by today's date
//     .snapshots();

// final DateTime now = DateTime.now(); // Get current date and time
// final DateTime today =
//     DateTime(now.year, now.month, now.day); // Get today's date without time
...
//             Timestamp.fromDate(today)) // Filter by today's date or later
//     .where("PostedAt",
//         isLessThan: Timestamp.fromDate(
//             today.add(Duration(days: 1)))) // Filter by before tomorrow
//     .snapshots();
